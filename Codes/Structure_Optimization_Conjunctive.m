...
for x = 1:no_of_solution_candidate_considered 
    ...
    L = N^T; % Number of rules (Because, We Are Considering Conjunctive Inference)
...
belief_degree_used = generate_belief_degree(optimal_ref_val_number, optimal_ref_val_number^T,seed)'
